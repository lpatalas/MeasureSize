...
GUID = '85861237-13e9-4517-8729-fce3a7bcb636'
...
FormatsToProcess = @('DriveSize.format.ps1xml', 'ItemSize.format.ps1xml')
...
CmdletsToExport = @('Measure-DriveSize', 'Measure-ItemSize')
